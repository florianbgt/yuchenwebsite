<template>
    <div>
        ...
        <b-navbar toggleable="md" fixed="top" type="dark" variant="secondary">
            <b-navbar-brand to="/">
                <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFC" width="48" height="48" viewBox="0 0 24 24">
                ...
                <strong>YuchenHua.com</strong>
            </b-navbar-brand>

            <b-navbar-toggle target="nav-collapse">
                <template>
                    <div class="text-light">
                        <fa :icon="['fas', 'bars']" style="font-size: 30px"/>
                    </div>
                </template>
            </b-navbar-toggle>
            ...
            <b-collapse id="nav-collapse" is-nav>           
                ...
                <b-navbar-nav class="ml-auto">
                    <b-nav-item href="https://blog.yuchenhua.com" target="_blank" class="active">
                        <big>Check out my blog!</big>
                    </b-nav-item>
                </b-navbar-nav>
            </b-collapse>
        </b-navbar>
